...
class AdventureGame{
    ...
    private Health=100;
    private maxDamage=50;
    private EnemyDamage =50;

    private Healthpotion=3;
    private maxEnemyHealth = 75;
    private HealthpotionHealupto=30;
    private  HealthpotionDropupto = 50;
 

    private  sleep = () => new Promise ((r) => {setTimeout(r,2000)})
  
    private  enemyList =['Warrior','Zombie','Assasian ','Skeleton']
...
public startgame(){
    ...
    console.log(
      `    =) Enemy can damage you UPTO ${this.EnemyDamage} Health    `
    );
    this.mainloop();
}
}
